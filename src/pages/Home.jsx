      ...
      <div className="max-w-7xl m-auto p-6 lg:px-20">
        ...
        <figcaption className="py-8">
          <p className="text-xl text-center">
            ...
            herbs inspired by ancient herbal secrets. After travelling the holy
            lands of India, Ayuvya Ayurveda brings a premium range of products
            that is perfected through science and will fit perfectly into your
            self-care regime and not the other way around.
          </p>
        </figcaption>
      </div>
      <ShopByConcern />
