  ...
  return (
    <div className="max-w-7xl mx-auto px-6 lg:px-40 lg:pb-10">
      ...
      <div className="text-lg flex flex-col gap-3 py-10">
        {" "}
        <p className="">
          Ayurveda House Private Limited respects an individual’s privacy and is
          committed to protecting the same. Our relationship with you is our
          most valuable asset and is the basis of our name and reputation.
        </p>
        <p className="">
          Our company{" "}
          <Link
          ...
          Ayurveda will collect, use, share and process personal information in
          relation to the services provided on the website.
        </p>
        <p className="">
          By providing your consent to the privacy policy, you expressly consent
          and agree to our use and disclosure of your personal information in
      ...
      <div className="text-lg flex flex-col gap-3 py-6">
        <p className="">
          ...
          Following are the categories of personal information that is collected
          by us-
        </p>
      ...
      <div className="">
        ...
        <ul className="list-disc ml-6 flex flex-col gap-2">
          ...
          <li className="">
            ...
            recommendations based on your past purchase behavior, communicating
            with you through phone, mobile application, or email, to notify you
            and send offers about our products and services.
          </li>
          <li className="">
      ...
      <div className="flex flex-col gap-2 py-6">
        <p className="">
          We use cookies to track your preferences and remember the information
          about your visit. You understand that a cookie is a small piece of
          data that is sent to your web browser from a web server and is
          eventually stored on your computer's hard drive. The Cookies may store
          a variety of information, including, the number of times that you
          access the website, registration information, and the number of times
          that you view a particular product or page on the Platform. The use of
          cookies is a common practice adopted by most major websites to better
        ...
        <p className="">
          You may choose to disable/decline cookies, however, the same may have
          a significant impact on your experience & you may lose some
      ...
      <p className="mt-6">
        ...
        we do not have any control over any other website. Therefore, we cannot
        be held responsible for the protection and privacy of any information
      ...
      <p className="mt-6">
        ...
        time, without notice of such update/change to any persons/ entity. Such
        changes shall be effective immediately upon posting on the website.
        Thus, you are advised to review this page periodically for any changes.
        You understand and agree that you shall be solely responsible for
        keeping yourself updated with this Privacy Policy.
      </p>
